<%@ Page Title="" Language="C#" MasterPageFile="~/design/AdminMasterPage.master" AutoEventWireup="true" CodeFile="QuanLyHangXe.aspx.cs" Inherits="QuanLyHangXe" %>
...
<asp:SiteMapPath ID="SiteMapPath1" runat="server" Font-Names="Verdana" 
    ...
    <div style ="clear:left; font-size: 14px; font-weight: bold;margin-left:30px" align="center">
            ...
            <asp:Label ID="Label4" runat="server" Text="Quản Lý Hãng Xe" Height="30px" 
...
<td>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Ma_Loai_Xe" HeaderText="Mã Loại Xe">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
            <asp:BoundField DataField="Ten_Loai_Xe" HeaderText="Tên Hãng Xe">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
        </Columns>
    ...
    <asp:Label ID="lblTen" runat="server" Height="27px" Text=" Tên Hãng Xe"></asp:Label>
&nbsp;<asp:TextBox ID="txtTenLoaiXe" runat="server"></asp:TextBox>
&nbsp;
   <asp:ImageButton
