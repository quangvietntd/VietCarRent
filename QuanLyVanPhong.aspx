<%@ Page Title="" Language="C#" MasterPageFile="~/design/AdminMasterPage.master" AutoEventWireup="true" CodeFile="QuanLyVanPhong.aspx.cs" Inherits="QuanLyVanPhong" %>
...
<asp:SiteMapPath ID="SiteMapPath1" runat="server" Font-Names="Verdana" 
    ...
    <div style ="clear:left; font-size: 14px; font-weight: bold;margin-left:30px" align="center">
            ...
            <asp:Label ID="Label4" runat="server" Text="Quản Lý Văn Phòng" Height="30px" 
                ForeColor="#FF6600" Font-Size="20px"></asp:Label>
        </div><div>&nbsp;</div>   
    <asp:MultiView ID="mtvQLVP" runat="server">
    <asp:View ID="ViewQLVP" runat="server">
...
<td>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="id" HeaderText="Mã Văn Phòng">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
            <asp:BoundField DataField="Ten_VP" HeaderText="Tên Văn Phòng">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
        </Columns>
    ...
    <asp:Label ID="lblTen" runat="server" Height="27px" Text=" Tên Văn Phòng"></asp:Label>
&nbsp;<asp:TextBox ID="txtTenVanPhong" runat="server"></asp:TextBox>
&nbsp;
   <asp:ImageButton
