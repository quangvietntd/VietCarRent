<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GiaoDienThueXe.aspx.cs" Inherits="GiaoDienThueXe" %>
...
<body>
    ...
    <span class="style2">VietCarRent</span><span class="rent_title3">&nbsp;&nbsp;&nbsp;<span 
            ...
            <div style="text-align:right;color:White">
                <asp:Label ID="lblAlert2" runat="server" Text=""></asp:Label></div>
    </div>
    ...
    <div class="footer"> 
        ...
        <div class="footer_content" >
            <div style="width:1020px;margin:0 auto;padding-top:25px">
                <div style="width:245px; float:left;"><a href="default.aspx">Trở lại giao diện chính của website</a></div>
