<%@ Page Title="" Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="HuongDanMuaHang.aspx.cs" Inherits="LienHe" %>
...
<div>&nbsp;</div>
        <div align="center">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/images/register.png" 
                ...
                Text="Hướng Dẫn Mua Hàng" Font-Bold="True" 
...
<div>&nbsp;
        ...
        <div id="Div4" runat=server style="margin-left:80px">
            <div style="float:left;clear:none;width:100%;">
                <asp:Label ID="Label1" runat="server" Text="1. Hãy khai báo đúng tên và mật khẩu của bạn trước khi mua hàng" ></asp:Label>
            </div>
        </div>
        <div id="Div6" runat=server  style="margin-left:80px">
            <div style="float:left;clear:none;width:100%">
                <asp:Label ID="Label2" runat="server" Text="2. Nếu bạn chưa có tài khoản. Hãy đăng ký ngay " ></asp:Label><a href="DangKy.aspx">tại đây!</a>
            </div>
        </div>
        ...
        <div style ="clear:left; font-size: 14px; font-weight: bold;margin-left:30px">
            <asp:Image ID="Image3" runat="server" Height="36px" 
                ImageUrl="~/images/user_icon.png" Width="36px" /><asp:Label ID="Label4" runat="server" Text="Bước 2: Mua Hàng" Height="30px" ForeColor="#666666"></asp:Label>
        </div>
        ...
        <div style="margin-left:80px">
            <div style="width:100%;float:left;clear:none">
                <asp:Label ID="Label6" runat="server" Text="2. Click vào nút 'Thêm Vào Giỏ Hàng' nếu bạn muốn mua loại xe đó."></asp:Label>
            </div>
            <div>
            </div>
        </div>
        <div style="margin-left:80px">
            <div style="width:100%;float:left;clear:none">
                <asp:Label ID="Label7" runat="server" Text="3. Trang Web sẽ chuyển đến 'Giỏ Hàng' của bạn." ></asp:Label>
            </div>
            <div>
            </div>
        </div>
...
<div>&nbsp;
        ...
        <div id="Div1"  style ="clear:left; font-size: 14px; font-weight: bold;margin-left:30px" runat="server" >
            <asp:Image ID="Image5" runat="server" ImageUrl="~/images/login_icon.jpg" 
                ...
                Text="Bước 3: Thanh Toán" ForeColor="#666666"></asp:Label>
        </div>
        <div>&nbsp;</div>
        <div id="Div5" runat=server style="margin-left:80px">
            <div style="float:left;clear:none;width:100%;">
                <asp:Label ID="Label10" runat="server" Text="1. Nếu bạn muốn mua loại xe bạn đã chọn. Hãy điền vào số lượng và Click 'Thanh Toán'." ></asp:Label>
            </div>
        </div>
        <div id="Div7" runat=server  style="margin-left:80px">
            <div style="float:left;clear:none;width:100%">
                <asp:Label ID="Label11" runat="server" Text="2. Nếu bạn muốn tiếp tục mua thì hãy Click 'Tiếp Tục Mua Hang'. Website sẽ chuyển đến danh mục sản phẩm bạn muốn mua." ></asp:Label>
            </div>
        </div>
        <div id="Div8" runat=server  style="margin-left:80px">
            <div style="float:left;clear:none;width:100%">
                <asp:Label ID="Label8" runat="server" Text="3. Nếu bạn muốn mua Loại xe yêu thích trên 'Danh Mục Sản Phẩm' Click vào 'Thêm Vào Giỏ Hàng'." ></asp:Label>
            </div>
        </div>
        <div id="Div9" runat=server  style="margin-left:80px">
            <div style="float:left;clear:none;width:100%">
                <asp:Label ID="Label13" runat="server" Text="4. Sau khi bạn Clik 'Thanh Toán'. Hãy điền đầy đủ thông tin theo yêu cầu." ></asp:Label>
            </div>
        </div>
        <div id="Div10" runat=server  style="margin-left:80px">
            <div style="float:left;clear:none;width:100%">
                <asp:Label ID="Label14" runat="server" Text="5. Cuối cùng, hãy Click 'Thanh Toán'. Thông tin của bạn sẽ được cập nhật. Chúng tôi sẽ gửi hàng theo đúng yêu cầu của bạn." ></asp:Label>
            </div>
        </div>
        <div>&nbsp;</div>
        <div align="center">
